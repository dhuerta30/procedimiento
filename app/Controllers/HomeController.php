...
class HomeController
{
			...
			$html .= '
				<tr style="white-space: nowrap;">
					...
					<td>
						...
						<a href="javascript:;" class="btn btn-primary btn-sm imprimir_solicitud" data-id="'.$row["id_datos_paciente"].'"><i class="fa fa-file-pdf"></i></a>
	...
	public function menu(){
		...
		$submenu->setSearchCols(array("nombre_submenu","url_submenu", "visibilidad_submenu", "icono_submenu", "orden_submenu"));
		$submenu->crudTableCol(array("nombre_submenu","url_submenu", "visibilidad_submenu", "icono_submenu", "orden_submenu"));
		$submenu->formFields(array("id_menu","nombre_submenu","url_submenu", "visibilidad_submenu", "icono_submenu", "orden_submenu"));
		...
		$submenu->fieldGroups("Name2", array("visibilidad_submenu", "icono_submenu"));
		...
		$submenu->fieldDataBinding("visibilidad_submenu", array("Mostrar" => "Mostrar", "Ocultar" => "Ocultar"), "", "", "array");
