 ...
 */
#[AsCommand(name: 'completion', description: 'Volcar el script de finalización del shell')]
final class DumpCompletionCommand extends Command
{
     ...
     * @deprecated since Symfony 6.1
     */
    protected static $defaultDescription = 'Volcar el script de finalización del shell';
