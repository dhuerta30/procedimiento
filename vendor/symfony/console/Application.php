...
class Application implements ResetInterface
{
    ...
    protected function getDefaultInputDefinition(): InputDefinition
    {
        return new InputDefinition([
            ...
            new InputOption('--help', '-h', InputOption::VALUE_NONE, 'Muestra ayuda para el comando dado. Cuando no se da ningún comando, muestra la ayuda para el <info>'.$this->defaultCommand.'</info> comando'),
            new InputOption('--quiet', '-q', InputOption::VALUE_NONE, 'No enviar ningún mensaje'),
            new InputOption('--verbose', '-v|vv|vvv', InputOption::VALUE_NONE, 'Aumente la detalle de los mensajes: 1 para salida normal, 2 para salida más detallada y 3 para depuración'),
            new InputOption('--version', '-V', InputOption::VALUE_NONE, 'Mostrar esta versión de la aplicación'),
            new InputOption('--ansi', '', InputOption::VALUE_NEGATABLE, 'Forzar (o desactivar --no-ansi) la salida ANSI', null),
            new InputOption('--no-interaction', '-n', InputOption::VALUE_NONE, 'No hagas ninguna pregunta interactiva'),
        ]);
    }
